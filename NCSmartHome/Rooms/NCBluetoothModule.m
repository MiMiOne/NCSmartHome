...
@interface NCBluetoothModule()<CBCentralManagerDelegate,CBPeripheralDelegate>
...
@end
@implementation NCBluetoothModule
#pragma mark 单例初始化
static NCBluetoothModule *_instance;
    ...
    if (![_deviceDic objectForKey:[peripheral name]]) {
        ...
        if (peripheral!=nil) {
            if ([peripheral name]!=nil) {
                if ([[peripheral name] hasPrefix:@"祥云智能1.0"]) {
